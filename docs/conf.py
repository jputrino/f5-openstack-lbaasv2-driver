# -*- coding: utf-8 -*-
#
# F5 OpenStack LBaaSv2 Driver documentation build configuration file,
# created by
...
latex_documents = [
    (master_doc, 'f5-openstack-lbaasv2-driver.tex',
     u'F5 OpenStack LBaaSv2 Driver Documentation',
...
.. |agent-url| raw:: html
    ...
    <a target="_blank" href="http://clouddocs.f5.com/products/openstack/agent/%(version)s/index.html">F5 OpenStack BIG-IP Controller</a>
''' % {
